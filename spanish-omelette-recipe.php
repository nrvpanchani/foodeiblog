...
<html lang="en">
	...
	<body>
		...
		<section class="single-post spad">
			<div class="single-post__hero set-bg" data-setbg="img/categories/categories-post/cp-5.jpg" style="background-position: center;"></div>
			<div class="container">
					...
					<div class="col-lg-8">
						<div class="single-post__title">
							...
							<div class="single-post__title__text">
								...
								<h4>Spanish Omelette Recipe | How to make Spanish Omelette</h4>
								<ul class="widget">
									<li>by Admin</li>
									<li>3 min read</li>
									<li>20 Comment</li>
						...
						<div class="single-post__recipe__details">
							...
							<div class="single-post__recipe__details__indegradients" style="display: inline-flex;width: 100%;">
								...
								<div style="width: 30%;">
									<h5>Nutrition</h5>										
									<ul>
										<li>Calories: <b>516</b></li>
										<li>Total fat: <b>43 g</b></li>
										<li>carbs: <b>23 g</b></li>
										<li>Protein: <b>12 g</b></li>
									</ul>
								</div>
							</div>
							<div class="single-post__recipe__details__direction">
								<h5>Directions</h5>
								<ul>
									<li><span>1.</span> Leave the potatoes skins on. Cut them into thick slices and chop the onion.</li>
									<li><span>2.</span> Heat the oil in a large pan, add onion and potatoes, covered them for 30 mins, exciting occasionally until potatoes gets softed. Strain the potatoes & onion through a colander into a bowl.</li>
									<li><span>3.</span> Beat eggs, and then stir into the potatoes with the parsley, pepper & salt. Heat a little of oil in a smaller pan.</li>
									<li><span>4.</span> When all set invert on a plate & slide back into pan & cook a few more min.</li>
									<li><span>5.</span> Slide on a plate & cool for 10 mins before serving.</li>
								</ul>
							</div>
						</div>
						...
						<div class="single-post__next__previous">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6">
									<a href="./french-omelette-recipe.php" class="single-post__previous">
