...
<html lang="en">
	...
	<body>
		...
		<section class="single-post spad">
			<div class="single-post__hero set-bg" data-setbg="img/categories/categories-post/cp-7.jpg" style="background-position: center;"></div>
			<div class="container">
					...
					<div class="col-lg-8">
						<div class="single-post__title">
							...
							<div class="single-post__title__text">
								...
								<h4>Dahi Vada Recipe | How to make Dahi Vada</h4>
								<ul class="widget">
									<li>by Admin</li>
									<li>3 min read</li>
									<li>20 Comment</li>
						...
						<div class="single-post__top__text">
							<p>
								Dahi Vada is One of the most popular dahi vada recipe from Gujarat, India. Dahi Vada is very common & made with dahi and vada.
							</p>
						</div>
						<div class="single-post__recipe__details">
							...
							<div class="single-post__recipe__details__indegradients">
								<div>
									<h5>Ingredients</h5>
									<ul>
										<li>1/2 Cup of Dal</li>
										<li>1/2 Cup of Moog Dal</li>
										<li>1 Cup Yogurt</li>
										<li>Spice, Jeera etc. to taste</li>
							...
							<div class="single-post__recipe__details__direction">
								<h5>Directions</h5>
								<ul>
									<li><span>1.</span> Soak dal in water for 4 hours. Blend in blender at medium speed using the minimum amount of water required to keep paste moving freely. Add salt and start heating oil.</li>
									<li><span>2.</span> Drop Spoonfuls of batter in the hot oil using a large tablespoon. Fry until golden brown.</li>
									<li><span>3.</span> Drop in water. Let it soak till ready to serve. Beat yogurt with milk. Add spice according to taste. Squeeze out water from the vada and add yogurt. Serve.</li>
								</ul>
							</div>
						</div>
