...
<html lang="en">
	...
	<body>
		...
		<section class="categories spad">
			<!-- <div class="container">
				<?php //require_once('home-category.php')  ?>
			</div> -->
			<div class="categories__post">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 col-md-8">
							<?php require_once('first-blog-section.php') ?>
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="categories__post__item">
										...
										<div class="categories__post__item__text">
											...
											<p>Aloo Gobi paratha is One of the most popular paratha recipe from Punjab, India. Aloo Gobi paratha is very common & made with aloo and gobi stuffing.
											</p>
										</div>
									</div>
									<div class="categories__post__item">
										...
										<div class="categories__post__item__text">
											...
											<p>French omelette or omelet as we Americans call it, is just eggs and butter, no filling. Omelette is one of the most fundamental dishes from egg...
											</p>
										</div>
									</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6">
									<div class="categories__post__item">
										...
										<div class="categories__post__item__text">
											...
											<p>A super delicious indo-chinese dish that will cater all your snack cravings and leave you wanting for more! This quick and easy dish is ideal for a party at home as well.
											</p>
										</div>
									</div>
									<div class="categories__post__item">
